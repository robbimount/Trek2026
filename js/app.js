// =============================================================
// Translations — Latin American Spanish
// =============================================================
...
const translations = {
  en: {
    ...
    'dates-title':       'Dates',
    'dates-primary':     'July 13–16, 2026',
    'dates-secondary':   'Four days \u2022 Three nights',
    'locations-title':   'Locations',
    'who-title':         'Who',
    'who-primary':       'ALL YOUTH',
    'who-secondary':     'Turning 14 in 2026 through Graduating Seniors',
    // Equipment Drop-Off
    'equip-heading':        'Equipment Drop-Off',
    'equip-intro':          'We load equipment the night before Trek. Any youth who cannot deliver their sleeping gear at their scheduled time must get it to their Ma & Pa before Sunday night.',
    'equip-everyone-title': 'Everyone — Before Your Loading Time',
    'equip-everyone-1':     'Make sure your packed garbage bag is labeled with your name, your Ma & Pa, and your ward.',
    'equip-everyone-2':     "Optional: Want your pillow for the bus ride? Don't pack it in your garbage bag — bring it with you Monday morning instead.",
    'equip-everyone-3':     'Do NOT bring your bucket of packed items or your water bottle at this time. Bring those, along with your drawstring backpack, the next morning.',
    'equip-mp-title':       'Ma & Pa — Arrive 15 Minutes Early',
    'equip-mp-1':           "Arrive 15 minutes before your company's loading time to pick up your family's material strips and journals.",
    'equip-mp-2':           'Meet your youth with these items before they load their sleeping gear into the trailers.',
    'equip-mp-3':           'Bring extra duct tape and markers in case your youth need help labeling their garbage bags.',
    'equip-schedule-title': 'Company Loading Schedule',
    'equip-col-company':    'Company',
    'equip-col-families':   'Families',
    'equip-col-loading':    'Loading Time',
    'equip-col-mp':         'Ma & Pa Meet',
    'equip-co-red':         'Red Company',
    'equip-red-load':       '5:00 PM',
    'equip-red-mp':         '4:45 PM',
    'equip-co-orange':      'Orange Company',
    'equip-orange-load':    '5:15 PM',
    'equip-orange-mp':      '5:00 PM',
    'equip-co-yellow':      'Yellow Company',
    'equip-yellow-load':    '5:30 PM',
    'equip-yellow-mp':      '5:15 PM',
    'equip-co-green':       'Green Company',
    'equip-green-load':     '5:45 PM',
    'equip-green-mp':       '5:30 PM',
    'equip-co-blue':        'Blue Company',
    'equip-blue-load':      '6:00 PM',
    'equip-blue-mp':        '5:45 PM',
    'equip-co-purple':      'Purple Company',
    'equip-purple-load':    '6:15 PM',
    'equip-purple-mp':      '6:00 PM',
    'equip-packing-btn':    'View the Packing List',
    // Theme
    'theme-heading':     'Theme',
    ...
    'about-p2':          'Reenacting a trek can provide a powerful opportunity to strengthen testimonies, build unity, do family history, and learn core gospel principles. Treks can also help youth learn about who they are and what they may become.',
    'about-martin-h3':   'Martin\'s Cove',
    'about-martin-p':    'Nestled along the Sweetwater River in central Wyoming, Martin\'s Cove is the site where members of the Martin Handcart Company sheltered from an early winter storm in 1856. Hundreds of pioneers endured extreme cold and exhaustion here, and their faith and perseverance left a permanent mark on Church history. Today the area is a sacred site visited by thousands each year.',
    'about-sixth-h3':    'Sixth Crossing',
    'about-sixth-p':     'Sixth Crossing marks the point where pioneer handcart companies forded the Sweetwater River for the sixth time on their journey to the Salt Lake Valley. Young men who witnessed the suffering at this crossing reportedly said they would never forget pulling the wagons through the icy water to help the freezing saints \u2014 an act of selfless service still commemorated today.',
    'about-quote':       '\u201cWe came through with the absolute knowledge that God lives, for we became acquainted with him in our extremities.\u201d',
    'about-cite':        '\u2014 Survivor of the Martin Handcart Company, 1856',
    'about-img-alt':     'Pioneer Trek scene at Martin\'s Cove, Wyoming',
    // Schedule
    'schedule-heading':  'Calendar of Events',
    'event-1-date':      'Apr 15, 2026',
    'event-1-name':      'Trek Kickoff Activity',
    'event-2-date':      'May 6, 2026',
    ...
    // Footer
    'footer-stake':      'Saratoga Springs, UT | Mount Saratoga Stake',
    'footer-church':     'The Church of Jesus Christ of Latter-day Saints',
    'footer-copy':       '\u00a9 2026 Mount Saratoga Stake. All rights reserved.',
  },
  ...
  es: {
    ...
    'dates-title':       'Fechas',
    'dates-primary':     '13 al 16 de julio de 2026',
    'dates-secondary':   'Cuatro d\u00edas \u2022 Tres noches',
    ...
    // Equipment Drop-Off
    'equip-heading':        'Entrega de Equipo',
    'equip-intro':          'Cargaremos el equipo la noche anterior al Trek. Todo joven que no pueda entregar su equipo para dormir a su hora asignada debe entregarlo a su Ma & Pa antes de la noche del domingo.',
    'equip-everyone-title': 'Todos \u2014 Antes de tu hora de carga',
    'equip-everyone-1':     'Aseg\u00farate de que tu bolsa de basura empacada est\u00e9 etiquetada con tu nombre, tu Ma & Pa y tu barrio.',
    'equip-everyone-2':     '\u00bfQuieres tu almohada para el viaje en autob\u00fas? No la empaques en tu bolsa de basura; tr\u00e1ela contigo el lunes por la ma\u00f1ana.',
    'equip-everyone-3':     'NO traigas tu cubeta con art\u00edculos empacados ni tu botella de agua en este momento. Tr\u00e1elas, junto con tu mochila con cordones, a la ma\u00f1ana siguiente.',
    'equip-mp-title':       'Ma & Pa \u2014 Lleguen 15 minutos antes',
    'equip-mp-1':           'Lleguen 15 minutos antes de la hora de carga de su compa\u00f1\u00eda para recoger las tiras de material y los diarios de su familia.',
    'equip-mp-2':           'Re\u00fananse con sus j\u00f3venes con estos art\u00edculos antes de que carguen su equipo para dormir en los remolques.',
    'equip-mp-3':           'Traigan cinta adhesiva y marcadores adicionales por si sus j\u00f3venes necesitan ayuda para etiquetar sus bolsas de basura.',
    'equip-schedule-title': 'Horario de Carga por Compa\u00f1\u00eda',
    'equip-col-company':    'Compa\u00f1\u00eda',
    'equip-col-families':   'Familias',
    'equip-col-loading':    'Hora de Carga',
    'equip-col-mp':         'Ma & Pa se re\u00fanen',
    'equip-co-red':         'Compa\u00f1\u00eda Roja',
    'equip-red-load':       '5:00 p. m.',
    'equip-red-mp':         '4:45 p. m.',
    'equip-co-orange':      'Compa\u00f1\u00eda Naranja',
    'equip-orange-load':    '5:15 p. m.',
    'equip-orange-mp':      '5:00 p. m.',
    'equip-co-yellow':      'Compa\u00f1\u00eda Amarilla',
    'equip-yellow-load':    '5:30 p. m.',
    'equip-yellow-mp':      '5:15 p. m.',
    'equip-co-green':       'Compa\u00f1\u00eda Verde',
    'equip-green-load':     '5:45 p. m.',
    'equip-green-mp':       '5:30 p. m.',
    'equip-co-blue':        'Compa\u00f1\u00eda Azul',
    'equip-blue-load':      '6:00 p. m.',
    'equip-blue-mp':        '5:45 p. m.',
    'equip-co-purple':      'Compa\u00f1\u00eda Morada',
    'equip-purple-load':    '6:15 p. m.',
    'equip-purple-mp':      '6:00 p. m.',
    'equip-packing-btn':    'Ver la Lista de Equipaje',
    // Theme
    'theme-heading':     'Tema',
    ...
    'about-p2':          'Recrear un trek puede brindar una oportunidad poderosa para fortalecer los testimonios, construir unidad, hacer historia familiar y aprender principios fundamentales del evangelio. Los treks tambi\u00e9n pueden ayudar a los j\u00f3venes a descubrir qui\u00e9nes son y en qui\u00e9nes pueden convertirse.',
    'about-martin-h3':   'Martin\'s Cove',
    'about-martin-p':    'Ubicado a lo largo del r\u00edo Sweetwater en el centro de Wyoming, Martin\'s Cove es el lugar donde miembros de la Compa\u00f1\u00eda de Carretillas Martin se refugiaron de una tormenta de invierno temprana en 1856. Cientos de pioneros soportaron fr\u00edo extremo y agotamiento all\u00ed, y su fe y perseverancia dejaron una huella permanente en la historia de la Iglesia. Hoy el \u00e1rea es un sitio sagrado visitado por miles cada a\u00f1o.',
    'about-sixth-h3':    'Sixth Crossing',
    'about-sixth-p':     'Sixth Crossing marca el punto donde las compa\u00f1\u00edas de carretillas vadearon el r\u00edo Sweetwater por sexta vez en su viaje al Valle del Lago Salado. Los j\u00f3venes que presenciaron el sufrimiento en este cruce dijeron que nunca olvidar\u00edan haber jalado los carros a trav\u00e9s del agua helada para ayudar a los santos que se congelaban \u2014 un acto de servicio desinteresado que se conmemora hasta hoy.',
    'about-quote':       '\u201cLlegamos con el conocimiento absoluto de que Dios vive, porque llegamos a conocerlo en nuestras aflicciones.\u201d',
    'about-cite':        '\u2014 Sobreviviente de la Compa\u00f1\u00eda de Carretillas Martin, 1856',
    'about-img-alt':     'Escena del Trek Pionero en Martin\'s Cove, Wyoming',
    // Schedule
    'schedule-heading':  'Calendario de Actividades',
    'event-1-date':      '15 de abril de 2026',
    'event-1-name':      'Actividad de Inicio del Trek',
    'event-2-date':      '6 de mayo de 2026',
    ...
    // Footer
    'footer-stake':      'Saratoga Springs, UT | Estaca Monte Saratoga',
    'footer-church':     'La Iglesia de Jesucristo de los Santos de los \u00daltimos D\u00edas',
    'footer-copy':       '\u00a9 2026 Estaca Monte Saratoga. Todos los derechos reservados.',
  },
};
...
function setLanguage(lang) {
  ...
  if (toggle) {
    ...
    toggle.setAttribute('aria-label', lang === 'en' ? 'Cambiar idioma a Español' : 'Switch language to English');
    toggle.dataset.lang = nextLang;
  }

  // Persist choice
  try { localStorage.setItem('trek-lang', lang); } catch (_) {}
}
...
(function initLang() {
  let lang = 'en';
  try {
    const stored = localStorage.getItem('trek-lang');
...
if (langToggle) {
  langToggle.addEventListener('click', () => {
    const next = langToggle.dataset.lang || 'es';
    setLanguage(next);
  });
}
